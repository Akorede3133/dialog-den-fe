...
const ImageMessage = ({ content, isSender, status }: ImageMessageProp) => {
  return (
    <div className={`${isSender ? ' bg-bg-silver dark:bg-sidebar-dark'  : `bg-[#1C9DEA] dark:bg-message-bg-blue text-white`} p-3 flex flex-col items-center gap-2 w-[170px] h-[170px] `}>
